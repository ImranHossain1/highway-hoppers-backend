...
const createUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        const signIn = yield auth_service_1.AuthService.loginUser(loginData);
        const { refreshToken } = signIn, others = __rest(signIn, ["refreshToken"]);
        const cookieOptions = {
...
const socialLogin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield auth_service_1.AuthService.socialLogin(req.body);
    const { refreshToken } = result, others = __rest(result, ["refreshToken"]);
    // set refresh token into cookie
    const cookieOptions = {
        secure: config_1.default.env === 'production',
