...
router.delete('/:id/cancel-single-pending-booking', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.TRAVELLER), booking_controller_1.BookingController.cancelSinglePendingBooking);
