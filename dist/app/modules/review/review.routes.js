...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.TRAVELLER, user_1.ENUM_USER_ROLE.DRIVER), review_controller_1.BusController.updateOneInDB);
