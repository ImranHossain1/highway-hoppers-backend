...
router.get('/driverSchedule', (0, auth_1.default)(user_1.ENUM_USER_ROLE.DRIVER), bus_schedule_controller_1.BusScheduleController.getByDriverId);
...
router.patch('/:id/update-status', (0, validateRequest_1.default)(bus_schedule_validations_1.BusValidation.updateStatus), (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.DRIVER), bus_schedule_controller_1.BusScheduleController.updateScheduleStatus);
